    ...
    return (
      <footer className="bg-foreground text-background">
        <div className="max-w-7xl mx-auto px-6 py-24">
          ...
          {/* Main Footer Links */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 pt-20 gap-12 lg:gap-8 border-t border-background/10">
            <div className="lg:col-span-2">
              ...
              <p className="text-background/60 text-base leading-relaxed max-w-xs mb-8">
                Documenting the raw beauty of our planet, one journey at a time.
                Join us in exploring the world&apos;s most extraordinary places.
              </p>
          ...
          <div className="mt-24 pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-8">
              <a
                href="#"
                className="text-background/40 hover:text-white text-sm flex items-center gap-1 transition-colors"
              >
