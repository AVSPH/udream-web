...
export const accommodations: AccommodationListing[] = [
  ...
  },
  {
    ...
    priceDisplay: "Add dates for price",
    priceNote: "The host prices this stay by date ~ add your check-in and checkout on Airbnb to see the exact total.",
    rating: 5.0,
    reviewCount: 14,
    guestFavorite: true,
    ...
    images: [
      ...
      { src: "/accommodations/belgrade-lela/balcony.jpg", alt: "Living area opening onto the spacious balcony", caption: "Out to the spacious balcony" },
